...
Public Const hc_message = 2
Public Const hc_payee = 3
Public Const hc_category = 4
Public Const hc_comment = 5

Public Const fdc_account = 1
Public Const fdc_operation = 2
Public Const fdc_mask = 3
Public Const fdc_payee = 4
Public Const fdc_category = 5
Public Const fdc_comment = 6
Public Const fdc_mark = 7
...
Public Const ac_discount = 7
Public Const ac_balance = 8
